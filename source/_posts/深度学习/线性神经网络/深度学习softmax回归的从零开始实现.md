...
就像我们从零开始实现线性回归一样，
我们认为softmax回归也是重要的基础，因此应该知道实现softmax回归的细节。
本节我们将使用刚刚在 图像分类数据集中引入的Fashion-MNIST数据集，
并设置数据迭代器的批量大小为256。
...
作为一个从零开始的实现，我们使用 线性回归的从零开始实现中定义的
